...
@ToString
@AllArgsConstructor
@Schema(description = "文件搜索结果项")
public class FileSearchItemVO implements Serializable {
    ...
    public FileSearchItemVO(Long id,
                            Integer fileType,
                            String originalName,
                            Integer category,
                            Long fileSize,
        ...
        this(id, fileType, originalName, category, fileSize, parentId, null, createTime, modifyTime);
    }
}
