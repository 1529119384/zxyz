...
public class VerifyCodeConfig {
    ...
    @Bean
    VerifyCodeHasher verifyCodeHasher(EmailProperties emailProperties) {
        return new VerifyCodeHasher(emailProperties.getVerifyCodePepper(),
                emailProperties.isVerifyCodeAllowInsecurePepper());
    }
}
